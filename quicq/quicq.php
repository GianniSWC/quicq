...
function quicq_adminpage() {
  if (get_option('quicq_enabled', 'quicq-page') != 1) {
...
?>
  <style>
    ...
    .quicq-admin input[type="checkbox"] {
      position: relative;
      top: 50%;
        ...
        <div class="col-12 py-3">
          <div class="quicq-card">
            ...
            <div class="my-auto">
              ...
              <a class="text-center btn-block py-2" target="_blank" href="https://afosto.app/auth/login"><?php _e('Log in', 'quicq'); ?></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-6">
          <div class="quicq-card ">
            <form method="post" action="options.php">
              ...
              <div class="pa-5 quicq-switcher quicq-margin">
                <div class="quicq-card-default quicq-card-body">
                  <div class="quicq-width-xlarge quicq-grid" quicq-grid="">
                    <div class="quicq-width-1-1@ quicq-width-2-3@m quicq-first-column">
                    ...
                    <div class="quicq-width-1-1@ quicq-width-1-3@m">
                      <label class="quicq-margin-left" for="quicq_enabled">
                        <input name="quicq_enabled" type="checkbox" value="1" <?php checked('1', get_option('quicq_enabled')); ?> />
                      </label>
                    </div>
                  </div>

                  <?php if (get_option('quicq_enabled', 'quicq-page') == 1) : ?>
                    <hr>
                    <div class="quicq-width-xlarge quicq-grid my-auto py-3" style="display: block !important;">
                      <div class="quicq-width-1-1@ quicq-width-2-3@m quicq-first-column">
                        <div class="quicq-h5 quicq-margin-remove"><?php echo _e('Basic URL', 'quicq'); ?></div>
                        <div class="quicq-text-meta"><?php echo _e('Example:', 'quicq'); ?> <span class="text-muted"> <?php echo _e('https://cdn.quicq.io/quicq/uploads', 'quicq'); ?> </span> </div>
                      </div>
                      <div class="quicq-width-1-1@ quicq-width-1-3@m" style="margin-top: 10px;">
                        <label class="quicq-margin-left" for="upload_url_path">
                          <input type="text" name="upload_url_path" value="<?php echo esc_attr(get_option('upload_url_path')); ?>" />
                        </label>
                      </div>
                    </div>
                  <?php endif; ?>
